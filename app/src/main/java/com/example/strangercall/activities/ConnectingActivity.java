...
import com.example.strangercall.databinding.ActivityConnectingBinding;
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getChildrenCount() > 0) {
                            ...
                            for (DataSnapshot childSnap : snapshot.getChildren()) {
                                ...
                                Log.e("kuch bhi",incoming);
                                String createdBy = childSnap.child("createdBy").getValue().toString();
