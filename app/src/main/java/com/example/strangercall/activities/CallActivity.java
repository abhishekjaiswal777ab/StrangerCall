...
import com.example.strangercall.databinding.ActivityCallBinding;
import com.example.strangercall.models.InterfaceJava;
...
public class CallActivity extends AppCompatActivity {
    ...
    void initializePeer() {
        ...
        if (createdBy!=null && username!=null&& createdBy.equalsIgnoreCase(username)) {
